...
minm=0.01;
maxm=0.02;
theta=minm+rand(127,numunits)*(maxm-minm);


phi=minm+rand(numunits,3)*(maxm-minm);
hiddeninp=zeros(numunits,1);
output=zeros(3,1);
iter=0;
initrate=0.05
tic
...
% plotx=[plotx;numunits]
% ploty=[ploty;testaccuracy]
...
% 
% 
% title('accuracy vs number of units')
